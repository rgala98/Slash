...
class FileOperation
{
	...
	boolean newFileFlag;
	String fileName;
	String applicationTitle="NoteIt";
	File fileRef;
	...
	boolean saveAsFile()
	{
		...
		do
		{
			...
			if(JOptionPane.showConfirmDialog(this.npd.f,"<html>"+temp.getPath()+" already exists.<br>Do you want to replace it?<html>",
	...
	void openFile()
	{
		...
		do
		{
			...
			JOptionPane.showMessageDialog(this.npd.f,"<html>"+temp.getName()+"<br>file not found.<br>"+
...
public class noteIt implements ActionListener, MenuConstants
{
...
// Main Action Performed 
	public void actionPerformed(ActionEvent ev)
	{
		...
		JOptionPane.showMessageDialog(noteIt.this.f, "WE BELIEVE IN SAVING PAPER SO NO PRINTING!!!","'GO GREEN'- EVS TEACHER",
		...
		{
			JOptionPane.showMessageDialog(noteIt.this.f, "NO FINDING","",
					JOptionPane.INFORMATION_MESSAGE);
		}
		...
		{
			JOptionPane.showMessageDialog(noteIt.this.f, "NO REPLACING","",
					JOptionPane.INFORMATION_MESSAGE);
		}

		else if(cmdText.equals(editGoTo))
		{
			if(noteIt.this.ta.getText().length()==0)
				return;	
			goTo();
		}
		...
		{
			JOptionPane.showMessageDialog(noteIt.this.f, "BARE WITH IT!!! NO FONTS","",
					JOptionPane.INFORMATION_MESSAGE);
		}
		...
		else if(cmdText.equals(helpAboutnoteIt))
		{
			JOptionPane.showMessageDialog(noteIt.this.f, aboutText, "Ayo!", JOptionPane.INFORMATION_MESSAGE);
		}
		else
...
//Who doesn't want colourful background and text.!?
		...
		if(backgroundDialog==null)
			...
			backgroundDialog=JColorChooser.createDialog
				...
				new ActionListener()
				{
					...
					{
					noteIt.this.ta.setBackground(bcolorChooser.getColor());
					}
				},
				null);		
	...
	void showForegroundColorDialog()
	{
		...
		if(foregroundDialog==null)
			...
			new ActionListener()
			{
					public void actionPerformed(ActionEvent evvv)
					{
						noteIt.this.ta.setForeground(fcolorChooser.getColor());
					}
			},
			null);		
...
//Creating Stuff Here
	...
	void createMenuBar(JFrame f)
	{
		...
		createMenuItem(helpAboutnoteIt,KeyEvent.VK_A,helpMenu,this);
		...
		public void menuSelected(MenuEvent evvvv)
		{
			...
			if(noteIt.this.ta.getSelectionStart()==ta.getSelectionEnd())
			{
...
interface MenuConstants
{
	...
	final String helpAboutnoteIt="About NoteIt";
	
	final String aboutText =
	        "<html><big>Note It</big><hr><hr>" +
	        "<strong>Created by Digital Joints Inc. ©</strong><br> <html>";
}
