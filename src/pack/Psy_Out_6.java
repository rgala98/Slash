 ...
 * @author Nisarg
 */
public class Psy_Out_6 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            ans = psy.fn(true,64,ans);
            this.dispose();
            //po.setVisible(true);
            psy.output(ans);
        } catch (InterruptedException ex) {
            Logger.getLogger(Psy_Out_6.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Psy_Out_6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Psy_Out_6(ans).setVisible(true);
            }
        });
    }
